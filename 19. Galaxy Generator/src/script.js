...
gui.add(parameters, 'branches').min(2).max(20).step(2).name('Branches Count').onFinishChange(generateGalaxy);
gui.add(parameters, 'spin').min(- 5).max(5).step(0.001).name('Spin Power').onFinishChange(generateGalaxy);
...
gui.add(parameters, 'insideColor').name('Inside Color').onFinishChange(generateGalaxy);
gui.add(parameters, 'outsideColor').name('Outside Color').onFinishChange(generateGalaxy);
